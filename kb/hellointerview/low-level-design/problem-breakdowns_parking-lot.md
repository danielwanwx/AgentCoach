...
Sort By
A
AdvancedRoseJunglefowl385
Top 5%
• 3 months ago

love that you covered concurrency 😌
...
Elevator is marked as easy and Parking Lot as medium. For me it should have been swapped.
...
Exactly. This one's easy.

2

Reply
H
HilariousTealTick930
Premium
• 3 months ago

Best resource for LLD prep is finally here!!
...
The content is to the point, covering exactly what is required for a LLD interview. Reading this feels like a flow :).

One minor correction:-
- activeTickets: Map<Ticket>  // Changed from List to Map
...
In case of multiple entrances, why is a RLock used in the python code? Afaiu it's not a ReadWrite lock like in Java
