...
Off topic comment: can you please introduce a dark mode for easier reading? thx.
...
Low pri but we'll try to get to it. For now, more content instead of dark mode :)
...
more content please instead of "filler" features :)

21

Reply
F
FeministEmeraldMule428
• 1 year ago

+1, more content please. Filtering is low priority

8

Reply
S
SpecialChocolateLocust543
Premium
• 1 year ago

+1 for the dark mode...some people have bright light issues. please consider this. Thanks

3

Reply
H
HistoricVioletMeerkat428
Top 10%
• 1 year ago

they can install a dark mode extension on their browser.

16

Reply
A
AutomaticMoccasinEchidna429
Premium
• 1 year ago

Just use a dark reader. I think focus on content is much more value add here.
...
Dark mode should be lowered its priority.

It is VERY EASY to tune to dark mode from browser level, you should have known this if you really have bright light issues.

I think it is the CONTENT that has the top priority than these P9 FRs.

7

Reply
E
ExtraSalmonCattle904
Premium
• 8 months ago

thanks for adding the dark mode. I love it lololol
...
FWIW, browser extensions like Dark Reader work reasonably well.
...
Here is a newer Discord post about how do they manage trillions of messages - 6 years after the linked original post: https://discord.com/blog/how-discord-stores-trillions-of-messages
...
I believe there is typo in "Fault Tolerance" section picture for step3.
"3. Hint stored for n7" -> it should be "3. Hint stored for n8"
