...
Reply
C
ChubbyAzureGibbon937
Premium
• 22 days ago

hi mai, I really like the way you delivered the content, it's very solid and dense while you still be able to communicate it in proper way, even for me who are still early stage learning this specifix topic. If you don't mind, can you share your process, like how usually do you prepare any content which will be published what are the reference you choose etc. Another thing I want to ask is that, what's your daily habit and learning process to become at this point, I truly inspired by most of your content here as I feel you have a very deep understanding and communicate it very well
...
Yeah we're going to remove the detail here and reference the more authoritative Consistent Hashing guide.
...
I dont think its faulty, I think the intention was to have virtual nodes in between the physical nodes, which would mean Node 8 data is going to spread fairly evenly to all the other nodes and not just to next node in clockwise direction.
...
Horizontal scaling might be one of the ways. Each server can handle 10,000 - 100,000 websocket/SSE connections. If we go with average of 10,000 connections per server we will need 100 servers to manage 10 million users. With kernel tweeks and enhancements this can be increased a lot. Something similar to the way whatsapp had done in their early days.
