...
Hi Evan, I was asked a variation of this question (https://www.hellointerview.com/premium/questions/cm5gdl97c0009356qbi9mp88b?company=Meta&level=SENIOR). It comes with additional constraints:

10,000 machines
Can't use external services (like S3 or Dynamo)
Internal network bandwidth is limited
...
Use Kubernetes to manage the crawling/storage clusters.
Choose Cassandra to store metadata because the access pattern is write-heavy.
