...
Awesome writeup Stefan !!
Would suggest folks to read Facebooks's Gorilla Paper if interested in details. Also Fabian's post https://web.archive.org/web/20220205173824/https://fabxc.org/tsdb/ is very useful in appreciating the high cardinality problem (esp. in modern k8s based deployments) and how the internal chunk/block layer was redesigned.
...
Great article as usual! Loved reading it!
I have not seen any other article on TimeSeries DBs that is so crisp, covers so many concepts and yet is so simple to understand.
...
Reply
V
VoicelessTealMongoose648
Premium
• 3 months ago

Worked Example: Multi-Tag Query

Love this section! Brings everything together, Read the article once and revise this section only when needed, you will get back the crux and will be ready to use it!
