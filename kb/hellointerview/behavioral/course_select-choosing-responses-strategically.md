...
> Source: https://www.hellointerview.com/learn/behavioral/course/select-choosing-responses-strategically
> Scraped: 2026-03-30
...
Before moving on:
Journal through your career using the category prompts above (high-impact projects, challenging situations, leadership moments, learning experiences, career transitions). Identify 3 to 5 core stories.
Fill out the story catalog worksheet for each core story. Capture Context, Actions, Results, Learnings, and Signal Areas. You're not writing a full interview answer. Just capture enough to remember what the story is and what signal it covers.
Identify your gaps. Review which signal areas your core stories don't cover. Use the per-signal-area journaling questions above to find 5 to 7 additional stories that fill those gaps.
...
Next: Deliver: Telling a Good Story
...
Anonymous
C
ConvincingCoffeeStingray199
Premium
• 1 day ago

I had already purchased a one-year membership, but this content inspired me to upgrade to a lifetime subscription — it's that good. I finally understand why I kept hitting dead ends after hiring manager rounds and recruiter screens. As a senior engineer, whenever I was asked about my favorite project, I would talk about small things I'd built that brought me joy and boosted my productivity. Now I realize I've been missing the bigger picture in terms of scope.
...
Also every other material just says use STAR but that's not enough if you missing the scope or main signals behind the question. Thank you peeps.
...
It’s frustrating when the video keeps freezing. It paused around 50 times. My network may not be stable tonight though. I was watching in fullscreen mode.
I believe you guys are technically solid — could you test watching it and help fix the issue?
For reference, I’m located in the Bay Area in case that helps with debugging.
...
Videos are hosted on Cloudflare and we haven't seen reports of issues from others. Would suggest looking at your client to see if anything is eating CPU or memory.
...
For the values and hypothetical question, how big should your example be after you've talked about the framework and scenarios? I'm thinking it should ideally be a compressed CARL answer. From the book, the "Responding to Values Question" has a very big response that makes me think it could be a full blown CARL answer too.
